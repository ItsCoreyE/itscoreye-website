...
export default function Footer() {
  ...
  const quickLinks = [
    ...
    { name: 'UGC Business', href: '#ugc-business' },
      ...
      <div className="container mx-auto px-5 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          ...
          >
            ...
            >
              <span className="text-2xl font-bold gradient-text">Corey Edwards</span>
            </a>
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Entrepreneur & Creator building transparent businesses and digital experiences people can trust.
            </p>
            <p className="text-gray-500 text-xs">
              Known as <span className="text-purple-400">ItsCoreyE</span>
            </p>
          </motion.div>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-2.5 rounded-lg bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:border-purple-500/50 hover:bg-purple-500/10 transition-all"
