...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[62vh] sm:min-h-[75vh] flex items-center justify-center px-5 sm:px-6 lg:px-8 pt-6 pb-10 sm:pt-20 sm:pb-16">
      <motion.div
      ...
      >
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-4 gradient-text-animated leading-tight tracking-tight"
        >
          Corey Edwards
        </motion.h1>
